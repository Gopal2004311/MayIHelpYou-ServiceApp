                ...
                <form id="emp-update-form" autocomplete="off">
                    ...
                    <div class="form-input-group">
                        <div class="form-element">
                            ...
                            <input class="form-input" type="number" name="adharNo" id="adharNo" placeholder="Employee Adhar no."/>
                        </div>
                        <div class="form-element">
                            <label class="form-label" for="adharImage">Upload Adhar Image </label>
                            <input class="input-file" type="file" accept="image/*" name="adharImage" id="adharImage" value="Upload file"/>
                    ...
                    <div class="form-input-group">
                        ...
                        <input class="form-input" type="text" name="panNo" id="panNo" placeholder="Employee Pan card no."/>
                         </div>
                        <div class="form-element">
                            <label class="form-label" for="panCardImage">Upload Pan Card Image </label>
                            <input class="input-file" type="file" accept="image/*" name="panCardImage" id="panCardImage" value="Upload file"/>
                    ...
                    <div class="form-element">
                        <button class="form-input button submit-btn" style="color: white; background-color: red;" id="delete">Delete</button>
                    </div>
                    </div>
        ...
        <div class="content">
            <div class="search-bar">
                ...
                <div class="table-box" style="overflow:scroll;">
                    <table>
                        <tr><!--emp_id	emp_name	email	mobile_no	emp_address	emp_age	adhar_card_no	pan_card_no	adhar_image	pan_card_image	status	password profile_picture-->
                            <th>Name</th>
                            <th>Email</th>
                            <th>Mobile No.</th>
                            <th>Address</th>
    ...
    <div class="form-container received-order-container" id="login-container">
        ...
        <img class="close-img" id="close-form-box" src="../img/icons/close.png" style="position:relative;top:2rem;">
            ...
            <form id="assign-category-form">
                ...
                <div class="form-element">
                    <button class="form-input button submit-btn" id="delete-from-cate-emp" style="color:white;background-color:red">Delete</button>
                </div>
                </div>
            </form>
        </div>
