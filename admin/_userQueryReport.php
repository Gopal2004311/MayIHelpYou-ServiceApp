...
?>
<head>
    <style>th,td{padding:1.5rem 1rem 1.5rem 1rem;}</style>
</head>
<body>
        ...
        <div class="form-box">
            ...
            <form id="mail-form">
                ...
                <div class="form-element">
                    ...
                    <textarea class="text-area"id="message" cols="30" rows="10" style="resize:none;padding:.5rem;" placeholder="Enter Message for Customer..."></textarea>
                </div>
                <div class="form-element">
