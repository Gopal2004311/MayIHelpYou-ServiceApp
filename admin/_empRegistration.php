            ...
            <div class="form-box">
                ...
                <form id="emp-registration-form" autocomplete="off">
                    ...
                    <div class="form-element">
                            ...
                            <input class="input-file" type="file" accept="image/*" name="adharImage" id="adharImage" value="Upload file" required />
                        </div>
                    </div>
                    <!-- two input tag side by side container -->
                    <div class="form-input-group">
                        ...
                        <div class="form-element">
                            ...
                            <input class="input-file" type="file" accept="image/*" name="panCardImage" id="panCardImage" value="Upload file" required />
                        </div>
                    </div>
                    <div class="form-element">
