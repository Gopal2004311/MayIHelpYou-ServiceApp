            ...
            <div class="table" style="overflow:scroll;">
                <table border="1px" cellspacing=0>
                    ...
                    <tr>
                         ...
                         <td><img src="<?php echo "../".$row['image_path'];?>" style="cursor: pointer;" class="original-img" data-link="<?php echo $row['service_id'];?>"></td>
    ...
    <div class="image-container received-order-container" id="image-content" style="display: none;">
        <div class="hidden-img">
                ...
                <div class="image-list" style="display: none;" data-target="<?php echo $row['service_id'];?>">
                    <div class="header">
                        <img src="../img/icons/close.png" id="close-img" class="close-btn" style="float:right;margin-top:2rem;">
