            ...
            <div class="form-box">
                ...
                <form id="update-service-form" autocomplete="off">
                    <div class="form-element">
                        ...
                        <input class="form-input" type="text" name="serviceName" id="serviceName" placeholder="Service Name"/>
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-element">
                            ...
                            <input class="form-input" type="number" name="servicePrice" id="servicePrice" placeholder="Price in Rs">
                        </div>
                        <div class="form-element">
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-element">
                            ...
                            <input class="input-file" type="file" accept="image/*" name="file" id="serviceImage" placeholder="Service Duration" value="Upload file" />
