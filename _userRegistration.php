        ...
        <div class="form-box">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="form-element">
                    ...
                    <input class="form-input" type="text" name="userName" id="userName" placeholder="First Middle Last Name" value="<?php if (isset($_POST['sign_up'])) echo $user_name;?>" required />
                    <small class="err-msg"><?php echo $userNameError; ?></small>
                </div>
                <div class="form-element">
                    <label class="form-label" for="userMobile">Mobile No.</label>
                    <input class="form-input" type="number" name="userMobile" id="userMobile" placeholder="Mobile Number" value="<?php if (isset($_POST['sign_up'])) echo $user_mobile;?>" required />
                    <small class="err-msg"> <?php echo $mobileError; ?></small>
                </div>
                <div class="form-element">
                    <label class="form-label" for="userEmail">E-mail</label>
                    <input class="form-input" type="email" name="userEmail" id="userEmail" placeholder="example123@gmail.com" value="<?php if (isset($_POST['sign_up'])) echo $user_email;?>" required />
                    <small class="err-msg"><?php echo $userEmailError; ?></small>
                </div>
                <div class="form-element">
                    <label class="form-label" for="userPassword">Password</label>
                    <input class="form-input" type="password" name="userPassword" id="userPassword" placeholder="Password" value="<?php if (isset($_POST['sign_up'])) echo $user_pass;?>" required />
                    <small class="err-msg"> <?php echo $passwordError; ?></small>
                </div>
                <div class="form-element">
                    <label class="form-label" for="userConPassword">Confirm Password</label>
                    <input class="form-input" type="password" name="userConPassword" id="userConPassword" placeholder="Confirm Password" value="<?php if (isset($_POST['sign_up'])) echo $user_con_pass;?>" required />
                    <small class="err-msg"><?php echo $ConPasswordError;?></small>
                </div>
                <div class="form-element">
                    <label class="form-label" for="city">City</label>
                    <input class="form-input" type="text" name="city" id="city" placeholder="Your city" value="<?php if (isset($_POST['sign_up'])) echo $city;?>" required />
                    <small class="err-msg"><?php echo $cityError; ?></small>
                </div>
                <div class="form-element">
                    <input class="form-input button submit-btn" type="submit" value="Sign Up" name="sign_up" id="sign_up">
                </div>
