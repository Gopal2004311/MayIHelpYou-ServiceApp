                ...
                <div class="payment-form">
                    <form id="orderForm" autocomplete="off">
                        ...
                        <div class="form-element">
                            ...
                            <input class="form-input" type="text" name="customerName" id="customerName" placeholder="Enter your address"
                            value="<?php echo $user_info['user_name']; ?>"required />
                        </div>
                        <div class="form-element">
                        ...
                        <div class="form-input-group">
                            ...
                            <div class="form-element">
                                ...
                                <input class="form-input" type="text" name="card_code" id="card_code" placeholder="CVC" />
                        ...
                        <div class="form-element">
                            <button class="form-input button submit-btn" name="booking" id="booking-btn">Book Now</button>
                        </div>
                    </form>
                </div>
            </div>
             ...
             <div class="container">
                <div class="scan-content">
                    <div class="scanner">
                     ...
                     <div class="notes">
                          <h2>Instructions:</h2>
                            <span> <img src="./img/icons/angle-down-solid.png"> The amount, which paid by you.this amount will reduce in final payment</span>
                            <span> <img src="./img/icons/angle-down-solid.png"> The amount, which paid by you.this amount will reduce in final payment</span>
                            <span> <img src="./img/icons/angle-down-solid.png"> The amount, which paid by you.this amount will reduce in final payment</span>
                            <span> <img src="./img/icons/angle-down-solid.png"> The amount, which paid by you.this amount will reduce in final payment</span>
                            <span> <img src="./img/icons/angle-down-solid.png"> The amount, which paid by you.this amount will reduce in final payment</span>
                ...
                <div class="form-content">
                  <form id="payment-details-form" autocomplete="off">
                    <div class="form-element">
                        ...
                        <input type="text" class="form-input" id="transactionId" placeholder="transaction id.." required>
                    </div>
                    <div class="form-element">
